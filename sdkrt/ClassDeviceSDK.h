...
namespace sdkrt
{
    ...
    //log
    public delegate int CallBackOnLog(int level, Platform::String^ tag, Platform::String^ filename, int line, Platform::String^ funcname, Platform::String^ data);
    //xiaowei
    ...
    private:
        ...
        static int on_device_log(int level, const char* tag, const char* filename, int line, const char* funcname, const char* data);
